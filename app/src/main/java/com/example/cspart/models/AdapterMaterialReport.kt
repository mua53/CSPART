...
class AdapterMaterialReport(context: Context, layoutInt: Int, var arrayList: List<MaterialInput>) : ArrayAdapter<MaterialInput>(context,
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        total.text = arrayList[position].quantityReal.toString()
